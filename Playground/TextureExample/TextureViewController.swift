...
final class TextureViewController: ASDKViewController<ASCollectionNode>, MosaicCollectionViewLayoutDelegate, ASCollectionDataSource, ASCollectionDelegate {
    ...
    internal func collectionView(
        ...
        originalItemSizeAtIndexPath: IndexPath
    ) -> CGSize {
...
fileprivate func convertFromNSAttributedStringKey(
